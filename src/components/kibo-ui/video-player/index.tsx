...
export const VideoPlayerTimeRange = ({
	...
	<MediaTimeRange className={cn("p-1", className)} {...props} />
);
...
export const VideoPlayerTimeDisplay = ({
	...
	<MediaTimeDisplay className={cn("p-1", className)} {...props} />
);
...
export const VideoPlayerVolumeRange = ({
	...
	<MediaVolumeRange className={cn("p-1", className)} {...props} />
);
...
export const VideoPlayerPlayButton = ({
	...
	<MediaPlayButton className={cn("p-1", className)} {...props} />
);
...
export const VideoPlayerSeekBackwardButton = ({
	...
	<MediaSeekBackwardButton className={cn("p-1", className)} {...props} />
);
...
export const VideoPlayerSeekForwardButton = ({
	...
	<MediaSeekForwardButton className={cn("p-1", className)} {...props} />
);
...
export const VideoPlayerMuteButton = ({
	...
	<MediaMuteButton className={cn("p-1", className)} {...props} />
);
...
export const VideoPlayerFullscreenButton = ({
	...
	<MediaFullscreenButton className={cn("p-1", className)} {...props} />
);
